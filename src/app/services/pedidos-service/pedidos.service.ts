...
import { DetalhesPedidoInterface, ItemPedidoInterface, PedidoInterface } from "src/app/models/interfaces/dto/pedido.interface";
...
export class PedidosService {
    ...
    solicitarTroca(itemPedido: ItemPedidoInterface): Observable<MessageInterface> {
        return this.http
            .put<MessageInterface>(`${this.baseUrl}/itenspedidos/solicitartroca/${itemPedido.id}`, null)
    }
    ...
    confirmarTroca(itemPedido: ItemPedidoInterface): Observable<MessageInterface>{
        return this.http.put<MessageInterface>(
            `${this.baseUrl}/itenspedidos/gerenciarsolicitacaotroca/${itemPedido.id}?status=TROCA_RECUSADA`,
            null
        );
